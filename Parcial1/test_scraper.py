...
from lambda_function import get_property_links, extract_property_data, download_and_process  # Importar funciones del scraper
...
def test_download_and_process(mock_requests_get):
    ...
    with patch("lambda_function.s3_client.put_object") as mock_put_object:
        ...
        # Verificar que se subieron los 10 archivos HTML + 1 CSV
        assert mock_put_object.call_count >= 11  # 10 HTML + 1 CSV
